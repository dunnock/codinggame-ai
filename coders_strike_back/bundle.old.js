	...
	class Pod {
	    ...
	    optimalMoveAI(hisPods = []) {
	        ...
	        if (this.velocityValue < 1000) {
	            let res = (0, _predictor2.default)({ pod: this, depth: 50 });
	    ...
	    runAwayFromEnemy() {
	        ...
	        let angleEnemyToCheckpoint = enemyVector.angleTo(this.checkpoint1Vector);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function predictOptions({ pod, depth = 50 }) {
	...
	const podStepsToPoint = (pod, point) => stepsToPoint(pod.velocity.value(), pod.directionStats(point).angle, pod.position, point);
