...
/***/function (module, exports, __webpack_require__) {
	...
	function predictOptions(_ref3) {
		...
		var _ref3$behaviour = _ref3.behaviour;
		var behaviour = _ref3$behaviour === undefined ? 'optimal' : _ref3$behaviour;
	...
	var PodActionsFastSpeed = function (_findsolution$Actions) {
		_inherits(PodActionsFastSpeed, _findsolution$Actions);
	...
	var PodActions = function (_findsolution$Actions2) {
		_inherits(PodActions, _findsolution$Actions2);
	...
	var MoveToCheckpoint1 = function (_findsolution$SmartAc) {
		...
		function MoveToCheckpoint1(_ref4) {
			...
			var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(MoveToCheckpoint1).call(this, { p1: p1, p2: p2, thrust: thrust }));

			_this5.name = "MoveToCheckpoint1";
			return _this5;
		}
	...
	var MoveViaCheckpoint1 = function (_MoveToCheckpoint) {
		...
		function MoveViaCheckpoint1(_ref5) {
			...
			var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(MoveViaCheckpoint1).call(this, { p1: p1, p2: p2, thrust: thrust }));

			_this6.distance = distance;
			_this6.name = "MoveViaCheckpoint1";
			_this6.P1P2 = new _vector2.default(_this6.p1, _this6.p2);
			return _this6;
		}
	...
	var MoveToCheckpoint2 = function (_findsolution$SmartAc2) {
		...
		function MoveToCheckpoint2(_ref6) {
			...
			var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(MoveToCheckpoint2).call(this, { p1: p1, p2: p2, thrust: thrust }));

			_this7.actionSteps = 3 + (200 - _this7.thrust) / 50;
			_this7.name = "MoveToCheckpoint2";
			return _this7;
		}
...
/***/function (module, exports, __webpack_require__) {
	...
	var ActionsTreeExpander = function (_TreeExpander) {
		...
		function ActionsTreeExpander(actions) {
			...
			var _this8 = _possibleConstructorReturn(this, Object.getPrototypeOf(ActionsTreeExpander).call(this));

			_this8.actions = actions;
			return _this8;
		}
	...
	var FailureResult = function (_Result2) {
		...
		function FailureResult(failure, _ref11) {
			...
			var _this10 = _possibleConstructorReturn(this, Object.getPrototypeOf(FailureResult).call(this, { success: false, result: { root: root } }));

			_this10.failure = failure;
			return _this10;
		}
...
/***/function (module, exports, __webpack_require__) {
	...
	var InformedActionsTreeExpander = function (_findsolution$Actions3) {
		_inherits(InformedActionsTreeExpander, _findsolution$Actions3);
	...
	var InformedDecisionTreeNode = function (_findsolution$Decisio) {
		...
		function InformedDecisionTreeNode(_ref13) {
			...
			var _this14 = _possibleConstructorReturn(this, Object.getPrototypeOf(InformedDecisionTreeNode).call(this, { action: action, parent: parent, state: state }));

			_this14.heuristic = heuristic;
			_this14.pathCost = parent ? parent.pathCost + action.cost(parent) : 0;
			_this14.targetEstimate = heuristic.apply(_this14.state);
			_this14.totalCostEstimate = _this14.pathCost + _this14.targetEstimate;
			return _this14;
		}
	...
	var HOBFS = function (_extendableBuiltin6) {
		...
		function HOBFS(compareFn) {
			...
			var _this15 = _possibleConstructorReturn(this, Object.getPrototypeOf(HOBFS).call(this));

			_this15.compare = compareFn;
			return _this15;
		}
