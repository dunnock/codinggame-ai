...
//		traceJSON("queue", queue);
		if(!(node instanceof DecisionTreeNode))
			throw new Error(`Incorrect node was generated by treeExpander: ${node}`);
		if(checkTarget(node))
			return new SuccessResult({node, root});
...
export { treeSearch, treeMaxSearch, startTreeDeepSearch, Result, DecisionTreeNode, SmartAction, ActionsTreeExpander, FunctionalActionsTreeExpander, DFS, BFS }
